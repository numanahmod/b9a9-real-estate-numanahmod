...
const Footer = () => {
    return (
        <div>
            ...
            <NavLink to='/login'className='fond-bold link link-hover'> LogIn    </NavLink>
                ...
                <hr className="w-full" />
                <aside>
                    <p>Copyright © 2024 - All right reserved by <span className=" font-semibold">Your Dream House</span> </p>
                </aside>
</footer>
        </div>
    );
